...
export class TradingChartComponent extends React.PureComponent<Props> {
    ...
    private setChart = (markets: Market[], currentMarket: Market) => {
        ...
        const widgetOptions = {
            ...
            overrides: {
                ['symbolWatermarkProperties.color']: '#1D193F',
                ['volumePaneSize']: 'iny',
                ...
                ['paneProperties.background']: '#1D193F',
                ['paneProperties.vertGridProperties.color']: '#1D193F',
                ['paneProperties.vertGridProperties.style']: 1,
                ['paneProperties.horzGridProperties.color']: '#1D193F',
                ['paneProperties.horzGridProperties.style']: 1,
                ['paneProperties.crossHairProperties.color']: '#1D193F',
                ['paneProperties.crossHairProperties.width']: 1,
                ['paneProperties.crossHairProperties.style']: 1,
                ['scalesProperties.backgroundColor']: '#1D193F',
            },
            loading_screen: {
                backgroundColor: '#1D193F',
            },
            popup_width: '000',
